...
let reflection () : string =
  "This problem set I found myself having to go back and reread sections of the
  book much more than on any other problem set. I thought that these problems 
  were the toughest ones by far as of yet. I had to really think through how some
  of the different parts of code would work and found myself getting stuck at a
  lot of parts. I started skipping parts where I got stuck and went back to them
  later that day or the next day and I found that when I did this often I could 
  figure out how to solve them. I know that if I worked with a partner I could 
  have finished it in much less time, but I felt that I would hold myself more
  accountable if I did it on my own and had to learn everything rather than a
  partner solving some parts that I got stuck on and me never fully understanding
  the solution." ;;
